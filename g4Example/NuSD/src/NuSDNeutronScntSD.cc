...
NuSDNeutronScntSD::NuSDNeutronScntSD(const G4String& name)
 : G4VSensitiveDetector(name),
   fHitsCollection(nullptr),
   fHCID{-1}      
{
  
  collectionName.insert("NeutronSDHitCol");
     
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

NuSDNeutronScntSD::~NuSDNeutronScntSD() 
{ 
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void NuSDNeutronScntSD::Initialize(G4HCofThisEvent* hce)
{
  // Create hits collection
  fHitsCollection = new NuSDNeutronScntSDHitsCollection(SensitiveDetectorName, collectionName[0]); 
...
G4bool NuSDNeutronScntSD::ProcessHits(G4Step* step, G4TouchableHistory* )
{  
  ...
  NuSDNeutronScntSDHit *hit  = new NuSDNeutronScntSDHit();
...
void NuSDNeutronScntSD::EndOfEvent(G4HCofThisEvent*) //works jest before endofEventAction method of eventAction class
{
...
void NuSDNeutronScntSD::PrintAll()
{
 
  G4cout<<"-------------------NeutronScntSD Output---------------------------------------"<<G4endl;
