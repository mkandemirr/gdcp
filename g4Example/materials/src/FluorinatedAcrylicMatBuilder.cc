...
FluorinatedAcrylicMatBuilder::FluorinatedAcrylicMatBuilder(const G4String& name, G4bool enableMatProp):
...
G4Material* FluorinatedAcrylicMatBuilder::CreateMaterial()          
{ 
